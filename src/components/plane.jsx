...
import { OrbitControls, PresentationControls, useGLTF, useKeyboardControls } from '@react-three/drei';
...
export const Plane = ({ modelPath = '/assets/models/airplane.glb', ...props }) =>
{
    ...
    return (
        <RigidBody colliders={false} ref={rigidBodyRef}>
            ...
            <group ref={groupRef}>
                ...
                <group rotation-y={Math.PI} {...props} scale={9}>
                    <mesh
                        castShadow
                        receiveShadow
